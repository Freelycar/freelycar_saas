...
//        String[] projectName = {"基础保养（更换机油机滤垫片）-汉兰达", "基础保养（更换机油机滤垫片）-八凯", "基础保养（更换机油机滤垫片）-小车型"};
        String[] projectName = {"机油保养(3系 F35/F30)", "机油保养(3系 G28/G20)", "机油保养(5系 G38/G30)","机油保养(5系 F18/F10)"};
        Float[] prices = {1076f, 1076f, 1076f,977f};
...
//        List<Project> projectList = projectRepository.findByDelStatusAndComment(false, "广汽丰田");
        List<Project> projectList = projectRepository.findByDelStatusAndComment(false, "宝利丰");
